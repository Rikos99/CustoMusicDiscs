package net.rikoz99_customusicdisks;
...
@Mod(CustoMusicDisks.MOD_ID)
public class CustoMusicDisks
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "customusicdisks";
